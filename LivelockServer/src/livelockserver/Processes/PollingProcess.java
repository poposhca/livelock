 ...
 * @author poposhca
 */
public class PollingProcess extends Thread implements IProcess
{
    ...
    public PollingProcess(int pollingTime, int sleepTime, IQueue inputQueue, IQueue outputQueue, OutputProcess out, ServerStats stats)
    {
